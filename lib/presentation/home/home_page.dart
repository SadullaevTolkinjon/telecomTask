        ...
        builder: (context, state) {
          return Buildable<HomeCubit, HomeState, HomeBuildable>(
              ...
              builder: (context, state) {
                ...
                if(state.success){
                   SnackbarWidgets.showSuccess(context,"Successfully registered!");
                }
...
//   final String _clientId = 'hasura';

//   final String _redirectUrl = 'com.telecomcar.debug://login';

//   final String _issuer = 'https://auth.utc.uz/realms/TelecomCarDev';
...
//     print("hereee-------->>>>>>>>");
//     print(response.authorizationCode);
//     setState(() {
//       /*
...
//           'google_client_id', authorizationResponse!.authorizationCode!));
